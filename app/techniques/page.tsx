  ...
  return (
    <div className="flex min-h-screen flex-1 flex-col bg-white text-zinc-950">
      ...
      <section className="px-14 pt-12">
        ...
        <h1 className="mt-3.5 text-[56px] font-semibold leading-[1.02] tracking-[-0.03em]">
          The full catalog.
        </h1>
        <p className="mt-3.5 max-w-[640px] text-[17px] leading-[1.55] text-zinc-600">
          Each card is a working playground — not a write-up. Hover to preview the demo, click to
          open it.
        </p>

        <div className="mt-8 flex items-center justify-between border-b border-zinc-200 pb-3.5">
          ...
          <div className="flex gap-[22px] font-mono text-xs text-zinc-500">
      ...
      <section className="flex flex-col gap-9 px-14 pt-8 pb-12">
        {families.map((family) => {
